          ...
          <el-form-item class="input" label="上课时间" prop="shangkeshijian">
              <el-input v-model="ruleForm.shangkeshijian" 
                placeholder="上课时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教学地点" prop="jiaoxuedidian">
          <el-input v-model="ruleForm.jiaoxuedidian" 
              placeholder="教学地点" clearable  :readonly="ro.jiaoxuedidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教学地点" prop="jiaoxuedidian">
              <el-input v-model="ruleForm.jiaoxuedidian" 
                placeholder="教学地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangkeshijian = true;
            continue;
	            	            ...
	            	            if(o=='jiaoxuedidian'){
            this.ruleForm.jiaoxuedidian = obj[o];
	    this.ro.jiaoxuedidian = true;
            continue;
          }
	            	            if(o=='tupian'){
	...
	this.ruleForm.kechengjieshao = this.ruleForm.kechengjieshao.replace(reg,'../../../springbootrpj39/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
